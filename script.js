...
const translations = {
  ru: {
    ...
    price_club_amt: '25 €',
    price_club_desc: 'Членство в Santiago Club — это закрытое сообщество. Эта цена доступна исключительно для подтвержденных участников. Свяжитесь с нами для проверки статуса.',
    price_club_btn: 'Подтвердить статус',
  ...
  ua: {
    ...
    price_club_amt: '25 €',
    price_club_desc: 'Членство в Santiago Club — це закрита спільнота. Ця ціна доступна виключно для підтверджених учасників. Зв\'яжіться з нами для перевірки статусу.',
    price_club_btn: 'Підтвердити статус',
